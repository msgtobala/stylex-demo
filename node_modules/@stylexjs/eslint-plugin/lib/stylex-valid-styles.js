...
const singleAnimationName = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('none'), _isAnimationName.default);
...
const flexGrow = _isNumber.default;
const flexShrink = _isNumber.default;
...
const baselinePosition = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('baseline'), (0, _makeLiteralRule.default)('first baseline'), (0, _makeLiteralRule.default)('last baseline'));
...
const selfPosition = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('center'), (0, _makeLiteralRule.default)('start'), (0, _makeLiteralRule.default)('end'), (0, _makeLiteralRule.default)('self-start'), (0, _makeLiteralRule.default)('self-end'), (0, _makeLiteralRule.default)('flex-start'), (0, _makeLiteralRule.default)('flex-end'));
...
const alignContent = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('flex-start'), (0, _makeLiteralRule.default)('flex-end'), (0, _makeLiteralRule.default)('center'), (0, _makeLiteralRule.default)('space-between'), (0, _makeLiteralRule.default)('space-around'), (0, _makeLiteralRule.default)('stretch'));
const alignItems = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('start'), (0, _makeLiteralRule.default)('end'), (0, _makeLiteralRule.default)('flex-start'), (0, _makeLiteralRule.default)('flex-end'), (0, _makeLiteralRule.default)('center'), (0, _makeLiteralRule.default)('baseline'), (0, _makeLiteralRule.default)('stretch'));
const alignSelf = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('auto'), (0, _makeLiteralRule.default)('flex-start'), (0, _makeLiteralRule.default)('flex-end'), (0, _makeLiteralRule.default)('center'), (0, _makeLiteralRule.default)('baseline'), (0, _makeLiteralRule.default)('stretch'));
...
const borderSpacing = _isNumber.default;
...
const columnCount = (0, _makeUnionRule.default)(_isNumber.default, (0, _makeLiteralRule.default)('auto'));
...
const columnWidth = (0, _makeUnionRule.default)(_isNumber.default, (0, _makeLiteralRule.default)('auto'));
...
const fontSizeAdjust = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('none'), _isNumber.default);
...
const fontWeight = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('normal'), (0, _makeLiteralRule.default)('bold'), (0, _makeLiteralRule.default)('bolder'), (0, _makeLiteralRule.default)('lighter'), (0, _makeLiteralRule.default)(100), (0, _makeLiteralRule.default)(200), (0, _makeLiteralRule.default)(300), (0, _makeLiteralRule.default)(400), (0, _makeLiteralRule.default)(500), (0, _makeLiteralRule.default)(600), (0, _makeLiteralRule.default)(700), (0, _makeLiteralRule.default)(800), (0, _makeLiteralRule.default)(900), _isCSSVariable.default);
...
const justifyContent = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('flex-start'), (0, _makeLiteralRule.default)('flex-end'), (0, _makeLiteralRule.default)('center'), (0, _makeLiteralRule.default)('stretch'), (0, _makeLiteralRule.default)('space-between'), (0, _makeLiteralRule.default)('space-around'), (0, _makeLiteralRule.default)('space-evenly'));
const justifyItems = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('start'), (0, _makeLiteralRule.default)('end'), (0, _makeLiteralRule.default)('flex-start'), (0, _makeLiteralRule.default)('flex-end'), (0, _makeLiteralRule.default)('center'), (0, _makeLiteralRule.default)('baseline'), (0, _makeLiteralRule.default)('stretch'));
const justifySelf = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('auto'), (0, _makeLiteralRule.default)('normal'), (0, _makeLiteralRule.default)('stretch'), baselinePosition, selfPosition, (0, _makeLiteralRule.default)('left'), (0, _makeLiteralRule.default)('right'));
...
const lineHeight = _isNumber.default;
...
const opacity = _isNumber.default;
const order = _isNumber.default;
const orphans = _isNumber.default;
const outline = _isString.default;
const overflow = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('visible'), (0, _makeLiteralRule.default)('hidden'), (0, _makeLiteralRule.default)('scroll'), (0, _makeLiteralRule.default)('auto'));
...
const scrollSnapPaddingBottom = _isNumber.default;
const scrollSnapPaddingTop = _isNumber.default;
...
const shapeImageThreshold = _isNumber.default;
...
const tabSize = _isNumber.default;
...
const widows = _isNumber.default;
...
const fill = paint;
const fillOpacity = _isNumber.default;
const fillRule = (0, _makeUnionRule.default)((0, _makeLiteralRule.default)('nonzero'), (0, _makeLiteralRule.default)('evenodd'));
const glyphOrientationHorizontal = _isNumber.default;
const glyphOrientationVertical = _isNumber.default;
...
const strokeMiterlimit = _isNumber.default;
const strokeOpacity = _isNumber.default;
...
const CSSProperties = {
  ...
  fillRule: fillRule,
  filter: filter,
  flex: showError('`flex` is not supported. Please use `flexGrow`, `flexShrink` and `flexBasis` instead'),
  flexBasis: flexBasis,
  ...
  flexWrap: flexWrap,
  float: float,
  font: showError('`font` is not supported. Please use `fontSize`, `fontFamily`, `fontStyle` etc. instead'),
  ...
  orphans: orphans,
  outline: outline,
  outlineColor: showError("'outlineColor' is not supported yet. Please use 'outline' instead"),
  outlineOffset: showError("'outlineOffset' is not supported yet. Please use 'outline' instead"),
  outlineStyle: showError("'outlineStyle' is not supported yet. Please use 'outline' instead"),
  outlineWidth: showError("'outlineWidth' is not supported yet. Please use 'outline' instead"),
  ...
  textDecorationColor: showError('`textDecorationColor` is not supported. Please use `textDecoration` instead.'),
  textDecorationLine: showError('`textDecorationLine` is not supported. Please use `textDecoration` instead.'),
  textDecorationSkip: showError('`textDecorationSkip` is not supported. Please use `textDecoration` instead.'),
  textDecorationStyle: showError('`textDecorationStyle` is not supported. Please use `textDecoration` instead.'),
...
const stylexValidStyles = {
  ...
  create(context) {
    ...
    for (const overrideKey in overrides) {
      ...
      const overrideValue = limit === null ? showError(reason) : limit === '*' ? (0, _makeUnionRule.default)(_isString.default, _isNumber.default, all) : limit === 'string' ? (0, _makeUnionRule.default)(_isString.default, all) : limit === 'number' ? (0, _makeUnionRule.default)(_isNumber.default, all) : typeof limit === 'string' || typeof limit === 'number' ? (0, _makeUnionRule.default)(limit, all) : Array.isArray(limit) ? (0, _makeUnionRule.default)(...limit, all) : undefined;
    ...
    function isStylexDeclaration(node) {
      return node && node.type === 'CallExpression' && isStylexCallee(node.callee) && node.arguments.length === 1 && node.arguments[0].type === 'ObjectExpression';
    }
    function checkStyleProperty(style, level, propName) {
      if (style.type === 'Property') {
        if (style.value.type === 'ObjectExpression') {
          ...
          const keyName = key.type === 'Literal' ? key.value : key.type === 'Identifier' && !style.computed ? key.name : null;
              ...
              if (params.some(param => param.type !== 'Identifier')) {
                return params.filter(param => param.type !== 'Identifier').forEach(param => {
                  context.report({
                    node: param,
                    loc: param.loc,
                    message: 'Dynamic Styles can only accept named parameters'
                  });
                });
              }
